...
<?php include("inc/header.inc"); ?>
	...
	<div class="slider_all pc">
		<div class="slider_base">
			<ul class="slider">
                <a href="<?php echo $_SESSION["rootDir"] ?>news/archives/1226"><img src="<?php echo $_SESSION["rootDir"] ?>images/top/slide/error.jpg" /></a>
                <a href="https://hrsn.jp/news/archives/2178"><img src="<?php echo $_SESSION["rootDir"] ?>images/top/slide/007.jpg" /></a>
				<a href="<?php echo $_SESSION["rootDir"] ?>news/archives/2359"><img src="<?php echo $_SESSION["rootDir"] ?>images/top/slide/IMG_0845.jpg" /></a>
				<a href="<?php echo $_SESSION["rootDir"] ?>contact.php?kbn=1"><img src="<?php echo $_SESSION["rootDir"] ?>images/top/slide/02.jpg" /></a>
				<a href="<?php echo $_SESSION["rootDir"] ?>contact.php"><img src="<?php echo $_SESSION["rootDir"] ?>images/top/slide/04.jpg" /></a>
			</ul>
			<div class="clear"></div>
		</div>
	</div>
				...
				<section id="link">
					<div class="section_inner">
						...
						<div id="catalog">
							...
							<img class="image" src="<?php echo $_SESSION["rootDir"] ?>images/top/chirashi.jpg" />
							<br />
							<p>
								最新のチラシをいつでも<br />
								パソコン・スマホからチェック！
							</p>
							<a href="<?php echo $_SESSION["rootDir"] ?>news/archives/2241"><img class="go" src="<?php echo $_SESSION["rootDir"] ?>images/go.png" /></a>
							<div class="clear"></div>
						</div>
					</div>
				</section>
...
?>
							<div class="clear"></div>
							<div class="link_img">
								<img src="<?php echo $_SESSION["rootDir"] ?>images/link_1.png" />
								<a href="<?php echo $_SESSION["rootDir"] ?>news/"><div>施工事例一覧はこちら</div></a>
							</div>
						</div>
					</div>
				</section>
...
<?php include("inc/plan.inc"); ?>
				...
				<section id="estimate">
					<img class="image" src="<?php echo $_SESSION["rootDir"] ?>images/top/008.jpg" />
					<div class="link_img">
						<img src="<?php echo $_SESSION["rootDir"] ?>images/link.png" />
						<a href="<?php echo $_SESSION["rootDir"] ?>news/archives/2178"><div>今すぐお見積りをご希望の方はこちら</div></a>
					</div>
				</section>
